    ...
    <header className="h-16 bg-white border-b border-slate-200 px-6 flex items-center justify-between sticky top-0 z-30 shadow-xs">
      ...
      <div className="relative w-full max-w-md">
        ...
        <input
          ...
          className="w-full bg-slate-100/80 border border-slate-200 focus:bg-white focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 rounded-xl pl-10 pr-12 py-2 text-sm text-slate-800 placeholder-slate-400 outline-none transition-all"
        />
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="bg-slate-100 border border-slate-200 hover:bg-slate-200/60 px-3 py-1.5 rounded-xl flex items-center gap-2 cursor-pointer transition-colors">
          ...
          <span className="text-[11px] text-emerald-600 font-bold">• Abierta</span>
        ...
        <div className="flex items-center gap-3 pl-2 border-l border-slate-200">
          ...
          <div className="flex items-center gap-2.5 pl-2 cursor-pointer" onClick={logout} title="Haz clic para cerrar sesión">
            ...
            <div className="text-left hidden md:block">
              ...
              <p className="text-[11px] font-medium text-slate-500">Administrador</p>
            </div>
          </div>
        </div>
      </div>
